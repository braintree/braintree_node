...
let BankAccountInstantVerificationJwt =
  require("./braintree/bank_account_instant_verification_jwt").BankAccountInstantVerificationJwt;
let BankAccountInstantVerificationJwtRequest =
  require("./braintree/bank_account_instant_verification_jwt_request").BankAccountInstantVerificationJwtRequest;

let LocalPaymentContext =
  require("./braintree/local_payment_context").LocalPaymentContext;
let LocalPaymentType =
  require("./braintree/local_payment_type").LocalPaymentType;
let ThreeDSecurePassThruNetwork =
  require("./braintree/three_d_secure_pass_thru_network").ThreeDSecurePassThruNetwork;
...
module.exports = {
  ...
  BankAccountInstantVerificationJwt: BankAccountInstantVerificationJwt,
  BankAccountInstantVerificationJwtRequest:
    BankAccountInstantVerificationJwtRequest,

  LocalPaymentContext: LocalPaymentContext,
  LocalPaymentType: LocalPaymentType,
  ThreeDSecurePassThruNetwork: ThreeDSecurePassThruNetwork,
