...
let UsBankAccountVerification = require('./us_bank_account_card_verification').UsBankAccountVerification;
...
class UsBankAccountVerificationSearch extends AdvancedSearch {
  static initClass() {
    ...
    this.multipleValueField('verificationMethod', {allows: UsBankAccountVerification.jerificationMethod.All()}); // eslint-disable-line new-cap
