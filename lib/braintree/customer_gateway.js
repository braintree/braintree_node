...
class CustomerGateway extends Gateway {
  ...
  find(customerId, associationFilterId) {
    ...
    if (associationFilterId) {
      if (Util.isInvalidPathSegment(associationFilterId)) {
        return Promise.reject(exceptions.NotFoundError("Not Found")); // eslint-disable-line new-cap
      }
  ...
  _createSignature() {
    return {
      valid: [
        ...
        "creditCard[threeDSecurePassThru][network]",
        "creditCard[options][accountInformationInquiry]",
        ...
        "applePayCard[networkTransactionId]",
        "applePayCard[number]",
        "applePayCard[billingAddress][countryName]",
        "applePayCard[billingAddress][firstName]",
        "applePayCard[billingAddress][lastName]",
        "applePayCard[billingAddress][locality]",
        "applePayCard[billingAddress][postalCode]",
        "applePayCard[billingAddress][region]",
        "applePayCard[billingAddress][streetAddress]",
        "applePayCard[options][verificationAccountType]",
        "applePayCard[options][verificationAmount]",
        "applePayCard[options][verificationMerchantAccountId]",
        "applePayCard[options][verifyCard]",
      ],
