...
class WebhookTestingGateway extends Gateway {
  ...
  subjectXmlFor(kind, id) { // eslint-disable-line complexity
    switch (kind) {
      ...
      case WebhookNotification.Kind.LocalPaymentExpired: return this.subjectXmlForLocalPaymentExpired(id);
      case WebhookNotification.Kind.LocalPaymentFunded: return this.subjectXmlForLocalPaymentFunded(id);
      ...
      case WebhookNotification.Kind.PaymentMethodCustomerDataUpdated: return this.subjectXmlForPaymentMethodCustomerDataUpdated(id);
      ...
      case WebhookNotification.Kind.TransactionReviewed: return this.subjectXmlForTransactionReviewed(id);
