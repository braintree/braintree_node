...
class TransactionGateway extends Gateway {
  ...
  pagingFunctionGenerator(search, options) {
    ...
    return super.pagingFunctionGenerator(search, 'transactions', Transaction, 'creditCardTransactions', response => response.creditCardTransactions.transaction, options);
  }
