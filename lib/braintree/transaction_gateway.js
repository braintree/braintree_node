...
class TransactionGateway extends Gateway {
  ...
  _createSignature() {
    let validKeys = [
      ...
      "customer[fax]",
      "customer[firstName]",
      "customer[internationalPhone][countryCode]",
      "customer[internationalPhone][nationalNumber]",
      "customer[lastName]",
      "customer[phone]",
      "customer[website]",
      ...
      "transfer[sender][accountReferenceNumberType]",
      ...
      "transfer[receiver][accountReferenceNumberType]",
