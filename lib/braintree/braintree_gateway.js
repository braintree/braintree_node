...
let BankAccountInstantVerificationGateway =
  require("./bank_account_instant_verification_gateway").BankAccountInstantVerificationGateway;
...
let CustomerSessionGateway =
  require("./customer_session_gateway").CustomerSessionGateway;
...
let LocalPaymentContextGateway =
  require("./local_payment_context_gateway").LocalPaymentContextGateway;
...
let PayPalPaymentResourceGateway =
  require("./paypal_payment_resource_gateway").PayPalPaymentResourceGateway;
...
class BraintreeGateway {
  constructor(config) {
    ...
    this.bankAccountInstantVerification =
      new BankAccountInstantVerificationGateway(this);
    ...
    this.localPaymentContext = new LocalPaymentContextGateway(this);
    this.merchantAccount = new MerchantAccountGateway(this);
    // NEXT_MAJOR_VERSION remove this
