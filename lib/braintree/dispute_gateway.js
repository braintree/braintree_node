...
class DisputeGateway extends Gateway {
  ...
  addFileEvidence(disputeId, documentId) {
    if (disputeId == null || disputeId.trim() === "") {
      return Promise.reject(new NotFoundError("dispute with id '" + disputeId + "' not found"), null);
    }
  ...
  finalize(id) {
    if (id == null || id.trim() === "") {
      return Promise.reject(new NotFoundError("dispute with id '" + id + "' not found"), null);
    }
  }
  ...
  removeEvidence(disputeId, evidenceId) {
    if (disputeId == null || disputeId.trim() === "" || evidenceId == null || evidenceId.trim() === "") {
      return Promise.reject(new NotFoundError("evidence with id '" + evidenceId + "' for dispute with id '" + disputeId + "' not found"), null);
    }
  }
}
