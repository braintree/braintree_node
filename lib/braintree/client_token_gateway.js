  ...
  generate(params) {
    ...
    if (
      ...
      params.paymentMethodId =
        params.preferredPaymentMethodToken ||
        params.preferred_payment_method_token;
      delete params.preferredPaymentMethodToken;
      delete params.preferred_payment_method_token;
    }
