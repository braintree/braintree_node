...
describe("Http", function () {
  describe("checkHttpStatus", function () {
    ...
    it("returns a request timeout error for 408  => ", function () {
      ...
      assert.equal(
        http.checkHttpStatus(408).type,
        braintree.errorTypes.requestTimeoutError
      );
    });
    ...
    it("returns an upgrade required error for 426  => ", function () {
      ...
      assert.equal(
        http.checkHttpStatus(426).type,
        braintree.errorTypes.upgradeRequired
      );
    });
    ...
    it("returns an not found error for 429  => ", function () {
      ...
      assert.equal(
        http.checkHttpStatus(429).type,
        braintree.errorTypes.tooManyRequestsError
      );
    });
    ...
    it("returns a server error for 500 =>", function () {
      ...
      assert.equal(
        http.checkHttpStatus(500).type,
        braintree.errorTypes.serverError
      );
    });
    ...
    it("returns a service unavailable error for 503 =>", function () {
      ...
      assert.equal(
        http.checkHttpStatus(503).type,
        braintree.errorTypes.serviceUnavailableError
      );
    });
    ...
    it("returns a gateway timeout error for 504  => ", function () {
      ...
      assert.equal(
        http.checkHttpStatus(504).type,
        braintree.errorTypes.gatewayTimeoutError
      );
    });
  });
