...
describe("TransactionGateway", function () {
  describe("sale", function () {
    ...
    it("handles error when exchangeRateQuoteId is invalid", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.equal(
            response.errors.for("transaction").on("exchangeRateQuoteId")[0]
              .code,
    ...
    it("passes scaExemption", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.isTrue(response.success);
          assert.equal(
            response.transaction.scaExemptionRequested,
            requestedExemption
          );
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.equal(
            ...
            ValidationErrorCodes.Transaction.Options.CreditCard
        ...
        function (err, response) {
          ...
          assert.equal(
            response.errors
              ...
              .on("accountType")[0].code,
            ValidationErrorCodes.Transaction.Options.CreditCard
              .AccountTypeDebitDoesNotSupportAuths
          );
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.equal(
            ...
            ValidationErrorCodes.Transaction.AmountNotSupportedByProcessor
          );
        ...
        function (err, response) {
          ...
          specHelper.defaultGateway.transaction.sale(
            ...
            function (err, response) {
              ...
              assert.equal(
                response.transaction.creditCard.cardholderName,
                "Adam Jones"
              );
              assert.equal(
                response.transaction.creditCard.maskedNumber,
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.equal(
            ...
            PaymentInstrumentTypes.CreditCard
          );
    ...
    it("calls callback with an error when options object contains invalid keys", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err) {
          ...
          assert.equal(
            err.message,
            "These keys are invalid: creditCard[fakeData]"
          );
          done();
        }
      );
      ...
      it("returns an error for transaction when ships from postal code is too long", function (done) {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            assert.isFalse(response.success, "response had no errors");
            assert.equal(
              response.errors.for("transaction").on("shipsFromPostalCode")[0]
                .code,
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("lineItems")
                .for("index1")
                .on("commodityCode")[0].code,
              ValidationErrorCodes.Transaction.LineItem.CommodityCodeIsTooLong
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("lineItems")
                .for("index1")
                .on("description")[0].code,
              ValidationErrorCodes.Transaction.LineItem.DescriptionIsTooLong
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("lineItems")
                .for("index1")
                .on("discountAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("discountAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.DiscountAmountIsTooLarge
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("kind")[0].code,
              ValidationErrorCodes.Transaction.LineItem.KindIsInvalid
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("kind")[0].code,
              ValidationErrorCodes.Transaction.LineItem.KindIsRequired
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("name")[0].code,
              ValidationErrorCodes.Transaction.LineItem.NameIsRequired
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("name")[0].code,
              ValidationErrorCodes.Transaction.LineItem.NameIsTooLong
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("lineItems")
                .for("index1")
                .on("productCode")[0].code,
              ValidationErrorCodes.Transaction.LineItem.ProductCodeIsTooLong
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("quantity")[0].code,
              ValidationErrorCodes.Transaction.LineItem.QuantityFormatIsInvalid
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("quantity")[0].code,
              ValidationErrorCodes.Transaction.LineItem.QuantityIsRequired
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("quantity")[0].code,
              ValidationErrorCodes.Transaction.LineItem.QuantityIsTooLarge
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("totalAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.TotalAmountIsRequired
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("totalAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.TotalAmountIsTooLarge
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("unitAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.UnitAmountIsRequired
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("unitAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.UnitAmountIsTooLarge
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("lineItems")
                .for("index1")
                .on("unitOfMeasure")[0].code,
              ValidationErrorCodes.Transaction.LineItem.UnitOfMeasureIsTooLong
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index1")
                .on("unitTaxAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.UnitTaxAmountIsTooLarge
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index0")
                .on("taxAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.TaxAmountFormatIsInvalid
            );
            done();
          }
        );
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors
                ...
                .for("index0")
                .on("taxAmount")[0].code,
              ValidationErrorCodes.Transaction.LineItem.TaxAmountIsTooLarge
            );
            done();
          }
        );
      ...
      it("handles validation errors on line items structure", function (done) {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            assert.isFalse(response.success, "response had no errors");
            assert.equal(
              response.errors.for("transaction").on("lineItems")[0].code,
              ValidationErrorCodes.Transaction.LineItemsExpected
            );
            done();
          }
        );
      ...
      it("handles validation errors on too many line items", function (done) {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.equal(
              response.errors.for("transaction").on("lineItems")[0].code,
              ValidationErrorCodes.Transaction.TooManyLineItems
            );
            done();
          }
        );
      ...
      it("returns network response code/text", function (done) {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.equal(
              response.transaction.networkResponseText,
            ...
            function (err, response) {
              ...
              assert.equal(
                response.errors
                  ...
                  .for("externalVault")
                  .on("status")[0].code,
                ValidationErrorCodes.Transaction.ExternalVault.StatusIsInvalid
              );
              done();
            }
          );
            ...
            function (err, response) {
              ...
              assert.equal(
                response.errors
                  ...
                  .for("externalVault")
                  .on("status")[0].code,
                ValidationErrorCodes.Transaction.ExternalVault
                  .StatusWithPreviousNetworkTransactionIdIsInvalid
              );
              done();
            }
          );
    ...
    context("with paypal here", function () {
      it("sets PayPalHere attributes on the transaction for auth captures", (done) =>
        specHelper.defaultGateway.transaction.find(
          "paypal_here_auth_capture_id",
          function (err, transaction) {
            assert.equal(
              transaction.paymentInstrumentType,
              PaymentInstrumentTypes.PayPalHere
            );
            ...
            assert.isNotNull(
              transaction.paypalHereDetails.transactionFeeAmount
            );
            assert.isNotNull(
              transaction.paypalHereDetails.transactionFeeCurrencyIsoCode
            );
            assert.isNotNull(
              transaction.paypalHereDetails.transactionInitiationDate
            );
            assert.isNotNull(
              transaction.paypalHereDetails.transactionUpdatedDate
            );
        ...
        specHelper.defaultGateway.customer.create({}, function () {
          ...
          specHelper.defaultGateway.transaction.sale(
            ...
            function (err, response) {
              ...
              assert.equal(
                response.transaction.paymentInstrumentType,
                PaymentInstrumentTypes.AndroidPayCard
              );
              assert.isString(
                response.transaction.androidPayCard.googleTransactionId
              );
              assert.equal(
        ...
        specHelper.defaultGateway.customer.create({}, function () {
          ...
          specHelper.defaultGateway.transaction.sale(
            ...
            function (err, response) {
              ...
              assert.equal(
                response.transaction.paymentInstrumentType,
                PaymentInstrumentTypes.VenmoAccount
              );
              assert.equal(
                response.transaction.venmoAccountDetails.username,
                "venmojoe"
              );
              assert.equal(
              ...
              assert.equal(
                response.transaction.venmoAccount.username,
                "venmojoe"
              );
              assert.equal(
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.equal(
              ...
              Transaction.GatewayRejectionReason.TokenIssuance
            );
            done();
          }
        );
      ...
      specHelper.defaultGateway.customer.create({}, function () {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.equal(
              response.transaction.paymentInstrumentType,
              PaymentInstrumentTypes.PayPalAccount
            );
            assert.equal(
              response.transaction.paypalAccount.payerId,
              "PAYER-123"
            );
            assert.equal(
              response.transaction.paypalAccount.paymentId,
              "PAY-1234"
            );
        ...
        specHelper.defaultGateway.customer.create({}, function () {
          ...
          specHelper.defaultGateway.transaction.sale(
            ...
            function (err, response) {
              ...
              assert.equal(
                response.transaction.paymentInstrumentType,
                PaymentInstrumentTypes.LocalPayment
              );
              ...
              assert.isNotNull(
                response.transaction.localPayment.transactionFeeAmount
              );
              assert.isString(
                response.transaction.localPayment.transactionFeeCurrencyIsoCode
              );
            ...
            function (err, response) {
              ...
              specHelper.defaultGateway.transaction.refund(
                ...
                function (err, response) {
                  ...
                  assert.isString(response.transaction.localPayment.paymentId);
                  assert.isString(
                    response.transaction.localPayment.fundingSource
                  );
                  assert.isString(response.transaction.localPayment.refundId);
                  assert.isString(response.transaction.localPayment.debugId);
                  assert.isNotNull(
                    response.transaction.localPayment
    ...
    context("with a paypal acount", function () {
                    ...
                    function (err, response) {
                      ...
                      specHelper.defaultGateway.transaction.sale(
                        ...
                        function (err, response) {
                          ...
                          assert.equal(response.transaction.type, "sale");
                          assert.isString(
                            response.transaction.paypalAccount.payerEmail
                          );
                          assert.isString(
                            response.transaction.paypalAccount.authorizationId
                          );
                          assert.isString(
                            response.transaction.paypalAccount.imageUrl
                          );
                          assert.isString(
                            response.transaction.paypalAccount.debugId
                          );
      ...
      context(
        "as a payment method nonce authorized for future payments",
        function () {
                    ...
                    specHelper.defaultGateway.customer.create({}, function () {
                      ...
                      specHelper.defaultGateway.transaction.sale(
                        ...
                        function (err, response) {
                          ...
                          assert.equal(response.transaction.type, "sale");
                          assert.isNull(
                            response.transaction.paypalAccount.token
                          );
                          assert.isString(
                            response.transaction.paypalAccount.payerEmail
                          );
      ...
      context(
        "as a payment method nonce authorized for one-time use",
        function () {
            ...
            specHelper.defaultGateway.customer.create({}, function () {
              ...
              specHelper.defaultGateway.transaction.sale(
                ...
                function (err, response) {
                  ...
                  assert.isString(response.transaction.paypalAccount.debugId);
                  assert.equal(
                    response.transaction.paypalAccount.payeeId,
                    "fake-payee-id"
                  );
            ...
            specHelper.defaultGateway.customer.create({}, function () {
              ...
              specHelper.defaultGateway.transaction.sale(
                ...
                function (err, response) {
                  ...
                  assert.isString(response.transaction.paypalAccount.debugId);
                  assert.equal(
                    response.transaction.paypalAccount.payeeEmail,
                    "payee@example.com"
                  );
            ...
            specHelper.defaultGateway.customer.create({}, function () {
              ...
              specHelper.defaultGateway.transaction.sale(
                ...
                function (err, response) {
                  ...
                  assert.isString(response.transaction.paypalAccount.debugId);
                  assert.equal(
                    response.transaction.paypalAccount.customField,
                    "custom field junk"
                  );
            ...
            specHelper.defaultGateway.customer.create({}, function () {
              ...
              specHelper.defaultGateway.transaction.sale(
                ...
                function (err, response) {
                  ...
                  assert.isTrue(response.success);
                  assert.equal(
                    response.transaction.paypalAccount.description,
                    "product description"
                  );
    ...
    it("can create transactions with custom fields", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.isTrue(response.success);
          assert.equal(
            response.transaction.customFields.storeMe,
            "custom value"
          );
    ...
    xit("handles risk_threshold rejection (test credit card number)", function (done) {
      ...
      specHelper.fraudProtectionEnterpriseGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          assert.equal(
            response.transaction.gatewayRejectionReason,
            Transaction.GatewayRejectionReason.RiskThreshold
          );
          done();
        }
      );
    ...
    it("handles descriptor validations", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          assert.isFalse(response.success, "response had no errors");
          assert.equal(
            response.errors.for("transaction").for("descriptor").on("name")[0]
              .code,
            ValidationErrorCodes.Descriptor.NameFormatIsInvalid
          );
          assert.equal(
            response.errors.for("transaction").for("descriptor").on("phone")[0]
              .code,
            ValidationErrorCodes.Descriptor.PhoneFormatIsInvalid
          );
          assert.equal(
            response.errors.for("transaction").for("descriptor").on("url")[0]
              .code,
        ...
        function (err, response) {
          ...
          assert.equal(
            response.errors
              .for("transaction")
              .for("industry")
              .on("checkOutDate")[0].code,
            ValidationErrorCodes.Transaction.IndustryData.Lodging
              .CheckOutDateMustFollowCheckInDate
          );
          assert.equal(
            response.errors.for("transaction").for("industry").on("roomRate")[0]
              .code,
            ValidationErrorCodes.Transaction.IndustryData.Lodging
              .RoomRateFormatIsInvalid
          );
          assert.equal(
            response.errors
              .for("transaction")
              .for("industry")
              .for("additionalCharges")
              .for("index0")
              .on("kind")[0].code,
            ValidationErrorCodes.Transaction.IndustryData.AdditionalCharge
              .KindIsInvalid
          );
        ...
        function (err, response) {
          ...
          assert.equal(
            response.errors
              .for("transaction")
              .for("industry")
              .on("travelPackage")[0].code,
            ValidationErrorCodes.Transaction.IndustryData.TravelCruise
              .TravelPackageIsInvalid
          );
        ...
        function (err, response) {
          ...
          assert.equal(
            response.errors
              ...
              .for("index0")
              .on("fareAmount")[0].code,
            ValidationErrorCodes.Transaction.IndustryData.Leg.TravelFlight
              .FareAmountCannotBeNegative
          );
      ...
      it("sub merchant accounts must provide a service fee", function (done) {
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.isFalse(response.success, "response had no errors");
            assert.equal(
              response.errors.for("transaction").on("merchantAccountId")[0]
                .code,
              ValidationErrorCodes.Transaction
                ...
                specHelper.makePastDue(response.subscription, function () {
                  ...
                  specHelper.defaultGateway.transaction.sale(
                    ...
                    function (err, response) {
                      ...
                      assert.exists(
                        response.transaction.authorizationExpiresAt
                      );
          ...
          function (nonce) {
            ...
            specHelper.defaultGateway.transaction.sale(
              ...
              function (err, response) {
                ...
                assert.equal(
                  response.transaction.gatewayRejectionReason,
                  Transaction.GatewayRejectionReason.ThreeDSecure
                );
        ...
        specHelper.defaultGateway.transaction.sale(
          ...
          function (err, response) {
            ...
            assert.isNotEmpty(
              ...
              "Response should contain error on authenticationResponse"
            );
            assert.equal(
              response.errors
                .for("transaction")
                .for("threeDSecurePassThru")
                .on("authenticationResponse")[0].code,
              ValidationErrorCodes.Transaction
          ...
          function (err, response) {
            ...
            assert.isNotEmpty(
              response.errors
                .for("transaction")
                .for("threeDSecurePassThru")
                .on("directoryResponse"),
              "Response should contain error on directoryResponse"
            );
            assert.equal(
              response.errors
                .for("transaction")
                .for("threeDSecurePassThru")
                .on("directoryResponse")[0].code,
              ValidationErrorCodes.Transaction
          ...
          function (err, response) {
            ...
            assert.isNotEmpty(
              response.errors
                ...
                .for("threeDSecurePassThru")
                .on("cavvAlgorithm"),
              "Response should contain error on cavvAlgorithm"
            );
            assert.equal(
              response.errors
                .for("transaction")
                .for("threeDSecurePassThru")
                .on("cavvAlgorithm")[0].code,
              ValidationErrorCodes.Transaction
    ...
    it("exposes authorizationAdjustments", function (done) {
      ...
      specHelper.defaultGateway.transaction.find(
        ...
        function (err, transaction) {
          ...
          assert.equal(
            authorizationAdjustment.processorResponseText,
            "Approved"
          );
          assert.equal(
            authorizationAdjustment.processorResponseType,
            "approved"
          );
    ...
    it("returns all the required paypal fields", (done) =>
      specHelper.defaultGateway.transaction.find(
        ...
        function (err, transaction) {
          ...
          assert.isString(
            transaction.paypalAccount.transactionFeeCurrencyIsoCode
          );
          assert.isString(
            transaction.paypalAccount.refundFromTransactionFeeAmount
          );
          assert.isString(
            transaction.paypalAccount.refundFromTransactionFeeCurrencyIsoCode
          );
          done();
        }
      ));
  ...
  describe("updateDetails", function () {
    it("updates the transaction details", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        transactionParams,
        (err, response) =>
          specHelper.defaultGateway.transaction.updateDetails(
            response.transaction.id,
            updateParams,
            function (err, response) {
              assert.isNull(err);
    ...
    it("validates amount", function (done) {
      ...
      let updateParams = { amount: "555.00" };
    ...
    it("validates orderId", function (done) {
      ...
      let updateParams = { orderId: new Array(257).join("X") };
        ...
        (err, response) =>
          specHelper.defaultGateway.transaction.updateDetails(
            ...
            function (err, response) {
              ...
              assert.isFalse(response.success, "response had no errors");
              assert.equal(
                response.errors.for("transaction").on("orderId")[0].code,
                "91501"
              );
    ...
    it("clones a transaction", function (done) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        function (err, response) {
          ...
          specHelper.defaultGateway.transaction.cloneTransaction(
            response.transaction.id,
            cloneParams,
            function (err, response) {
              assert.isTrue(response.success);
  ...
  describe("submitForPartialSettlement", function () {
    ...
    context("shared payment methods", function () {
      ...
      before(function (done) {
        ...
        return partnerMerchantGateway.customer.create(
          ...
          function (err, response) {
            ...
            return partnerMerchantGateway.address.create(
              addressParams,
              function (err, response) {
          ...
          function (err, response) {
            ...
            specHelper.defaultGateway.transaction.sale(
              ...
              function (err, response) {
                assert.isTrue(response.success);
                assert.equal(
                  response.transaction.facilitatedDetails.merchantId,
                  "integration_merchant_id"
                );
                assert.equal(
                  response.transaction.facilitatedDetails.merchantName,
                  "14ladders"
                );
                assert.equal(
                  response.transaction.facilitatedDetails.paymentMethodNonce,
                  nonce
                );
                assert.equal(
                  response.transaction.facilitatorDetails
                    .oauthApplicationClientId,
                  "client_id$development$integration_client_id"
                );
                assert.equal(
                  response.transaction.facilitatorDetails.oauthApplicationName,
                  "PseudoShop"
                );
      ...
      it("allows transactions to be created with a shared payment method token, customer, billing and shipping addresses", function (done) {
        ...
        grantingGateway.transaction.sale(
          transactionParams,
          function (err, response) {
            assert.isTrue(response.success);
            ...
            assert.equal(
              response.transaction.shipping.firstName,
              address.firstName
            );
            assert.equal(
              response.transaction.billing.firstName,
              address.firstName
            );
            assert.equal(
              facilitatedDetails.merchantId,
              "integration_merchant_id"
            );
            assert.equal(facilitatedDetails.merchantName, "14ladders");
            assert.isUndefined(facilitatedDetails.paymentMethodNonce);
            assert.equal(
              facilitatorDetails.oauthApplicationClientId,
              "client_id$development$integration_client_id"
            );
      ...
      it("allows transactions to be created with a shared payment method nonce, customer, billing and shipping addresses", function (done) {
        partnerMerchantGateway.paymentMethodNonce.create(
          creditCard.token,
          function (err, result) {
            if (err) {
              done(err);
            ...
            grantingGateway.transaction.sale(
              ...
              function (err, response) {
                ...
                let facilitatedDetails =
                  response.transaction.facilitatedDetails;
                let facilitatorDetails =
                  response.transaction.facilitatorDetails;
                ...
                assert.equal(
                  facilitatorDetails.oauthApplicationName,
                  "PseudoShop"
                );
