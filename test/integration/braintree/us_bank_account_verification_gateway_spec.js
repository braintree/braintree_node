            ...
            let paymentMethodParams = {
              ...
              options: {
                ...
                usBankAccountVerificationMethod:
                  UsBankAccountVerification.VerificationMethod.MicroTransfers,
              },
            };
              ...
              (err, response) => {
                ...
                gateway.usBankAccountVerification.confirmMicroTransferAmounts(
                  ...
                  (err, response) => {
                    ...
                    assert.equal(
                      response.errors
                        .for("usBankAccountVerification")
                        .on("base")[0].code,
                      ValidationErrorCodes.UsBankAccountVerification
                        .AmountsDoNotMatch
                    );
                              ...
                              (err, response) => {
                                ...
                                gateway.usBankAccountVerification.confirmMicroTransferAmounts(
                                  ...
                                  (err, response) => {
                                    ...
                                    assert.equal(
                                      response.usBankAccountVerification.status,
                                      UsBankAccountVerification.StatusType
                                        .GatewayRejected
                                    );
            ...
            function (nonce) {
              ...
              specHelper.defaultGateway.paymentMethod.create(
                ...
                function (err, response) {
                  ...
                  specHelper.defaultGateway.usBankAccountVerification.find(
                    verification.id,
                    function (err, foundVerification) {
                      assert.isNull(err);
                      assert.equal(verification.id, foundVerification.id);
                      assert.equal(
                        verification.verificationMethod,
                        foundVerification.verificationMethod
                      );
            ...
            function (nonce) {
              ...
              specHelper.defaultGateway.paymentMethod.create(
                ...
                function (err, response) {
                  ...
                  specHelper.defaultGateway.usBankAccountVerification.search(
                    function (search) {
                    ...
                    function (err, response) {
                      ...
                      return response.first(function (err, foundVerification) {
                        ...
                        assert.equal(
                          foundVerification.verificationMethod,
                          createdVerification.verificationMethod
                        );
                        assert.equal(
                          foundVerification.status,
                    ...
                    function (err, response) {
                      ...
                      specHelper.defaultGateway.usBankAccountVerification.search(
                        ...
                        function (err, response) {
                          ...
                          assert.equal(
                            verifications[0].verificationMethod,
                            UsBankAccountVerification.VerificationMethod
                              .IndependentCheck
                          );
                          assert.equal(
                            verifications[1].verificationMethod,
                            UsBankAccountVerification.VerificationMethod
                              .IndependentCheck
                          );
