        ...
        function (err, response) {
          ...
          specHelper.defaultGateway.customer.find(
            ...
            function (err, customer) {
              ...
              assert.equal(
                customer.samsungPayCards[0].token,
                samsungPayCard.token
              );
    ...
    specHelper.defaultGateway.customer.create({}, function (err, response) {
      ...
      specHelper.defaultGateway.paymentMethod.create(
        ...
        function (err, response) {
          ...
          assert.equal(
            samsungPayCard.billingAddress.streetAddress,
            "123 Fake St"
          );
      ...
      (err, response) => {
        ...
        let search = function (search) {
          ...
          search
            ...
            .is(PaymentInstrumentTypes.SamsungPayCard);
    ...
    specHelper.defaultGateway.customer.create({}, function (err, response) {
      ...
      specHelper.defaultGateway.transaction.sale(
        ...
        (err, response) => {
          ...
          assert.equal(
            samsungPayCardDetails.constructor.name,
            "SamsungPayCard"
          );
