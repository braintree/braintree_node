  ...
  describe("create", () => {
    ...
    it("returns error when unsupported file type", () => {
      let file = fs.createReadStream(
        "./test/fixtures/gif_extension_bt_logo.gif"
      );
      let params = {
        kind: "evidence_document",
        file: file,
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.equal(
            ValidationErrorCodes.DocumentUpload.FileTypeIsInvalid,
            error.code
          );
        });
    });
    ...
    it("returns error when malformed file", () => {
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.isFalse(response.success);
          assert.equal(
            ValidationErrorCodes.DocumentUpload.FileIsMalformedOrEncrypted,
            error.code
          );
        });
    });
    ...
    it("returns error when invalid kind", () => {
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.isFalse(response.success);
          assert.equal(
            ValidationErrorCodes.DocumentUpload.KindIsInvalid,
            error.code
          );
        });
    });
    ...
    it("returns error when file is over 4mb", () => {
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.isFalse(response.success);
          assert.equal(
            ValidationErrorCodes.DocumentUpload.FileIsTooLarge,
            error.code
          );
        });
    });
    ...
    it("returns error when file is empty", () => {
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.isFalse(response.success);
          assert.equal(
            ValidationErrorCodes.DocumentUpload.FileIsEmpty,
            error.code
          );
        });
    });
    ...
    it("returns error when pdf file is > 50 pages", () => {
      ...
      return specHelper.defaultGateway.documentUpload
        ...
        .then((response) => {
          ...
          assert.isFalse(response.success);
          assert.equal(
            ValidationErrorCodes.DocumentUpload.FileIsTooLong,
            error.code
          );
        });
    });
