"use strict";
/* eslint-disable no-loop-func,no-mixed-operators */
        ...
        function (err, response) {
          ...
          specHelper.defaultGateway.subscription.create(
            ...
            function (err, response) {
              ...
              let billingCyclesRemaining =
                Number(response.subscription.numberOfBillingCycles) - 1;
        ...
        function (err, response) {
          ...
          specHelper.defaultGateway.subscription.create(
            ...
            function (err, response) {
              ...
              let search = specHelper.defaultGateway.subscription.search(
                (search) => search.id().is(subscriptionId)
              );
