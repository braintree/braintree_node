...
describe('Dispute', function () {
  let attributes = {
    ...
    "status": "open",
    "updatedAt": "2013-04-10", //datetime(2013, 4, 10, 10, 50, 39),
    "evidence": [{
      "comment": null,
      "createdAt": "2013-04-11", //datetime(2013, 4, 11, 10, 50, 39),
      "id": "evidence1",
    ...
    "statusHistory": [{
      ...
      "status": "open",
      "timestamp": "2013-04-10", //datetime(2013, 4, 10, 10, 50, 39),
    }],
    "transaction": {
      "id": "transaction_id",
      "amount": "100.00",
      "createdAt": "2013-03-19", //datetime(2013, 3, 19, 10, 50, 39),
      "orderId": null,
