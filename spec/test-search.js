...
class TestSearch extends AdvancedSearch {
  constructor () {
    ...
    this.multipleValueField = AdvancedSearch.multipleValueField('multipleWithAllows', { allows : ['Hello', 'World'] })
    this.multipleValueOrTextField = AdvancedSearch.multipleValueOrTextField('multipleValueOrText')
