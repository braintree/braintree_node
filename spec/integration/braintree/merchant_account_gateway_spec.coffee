...
describe "MerchantAccountGateway", ->
  ...
  describe "createForCurrency", ->
    ...
    it "returns error if merchant account exists for currency", (done) ->
      gateway = braintree.connect {
        clientId: 'client_id$development$signup_client_id'
        clientSecret: 'client_secret$development$signup_client_secret'
      }
    ...
    it "returns error if currency is not provided", (done) ->
      gateway = braintree.connect {
        clientId: 'client_id$development$signup_client_id'
        clientSecret: 'client_secret$development$signup_client_secret'
      }
    ...
    it "returns error if currency is invalid", (done) ->
      gateway = braintree.connect {
        clientId: 'client_id$development$signup_client_id'
        clientSecret: 'client_secret$development$signup_client_secret'
      }
    ...
    it "returns error if merchant account exists for id", (done) ->
      gateway = braintree.connect {
        clientId: 'client_id$development$signup_client_id'
        clientSecret: 'client_secret$development$signup_client_secret'
      }
